    ...
    #define TOLERANCE_AMR       5E-6
    #define __CGrad_TOLERANCE__  1E-9
    #define DISC_RADIUS         6.49

    // Phase space information
    #define PHASE_SPACE_DIMENSIONS  2
    #define DOMAIN_INF {-10, -10}
    #define DOMAIN_SUP {10, 10}
    #define FINEST_DISCR_LVL 10
    
    // Timing definitions:
    #define INIT_TIME 0
    #define FINAL_TIME 4.0
    #define TIME_STEP 0.002
    #define REINIT_STEPS 5
    ...
    #define VF_2 (floatType)parameter.sample_vec[0]*(1 - powf(X.dim[0], 2))*X.dim[1] - 5*X.dim[0]
    ...
    static const floatType	IC_STD[PHASE_SPACE_DIMENSIONS] = { sqrtf(0.3), sqrtf(0.3) };
    ...
    static floatType 		_DIST_STD[PARAM_SPACE_DIMENSIONS] = {sqrtf(0.9)};
    static floatType 		_DIST_N_SAMPLES[PARAM_SPACE_DIMENSIONS] = {100};
