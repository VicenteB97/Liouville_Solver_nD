...
- WINDOWS:
C++ compiler: MSVC (built in 19.36)
...
- Added the possibility of storing full, or partial information in separate '.bin' (binary) files, where each file can be 1 GB at most. This
  can also be changed in the 'Case_definition.cuh' file. Files are stored in parallel, but the naming makes sure that the simulation is stored 
  correctly.
...
For any other doubts, feel free to ask for help at: vizenzo97@gmail.com