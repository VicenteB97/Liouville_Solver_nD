...
int16_t PDF_ITERATIONS(	cudaDeviceProp*				prop,
	...
	const UINT MAX_MEMORY_USABLE = 0.9 * (prop->totalGlobalMem - aux_Samples * sizeof(Param_pair) - Grid_Nodes * sizeof(TYPE));		// max memory to be used in bytes
