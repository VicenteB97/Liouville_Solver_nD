...
static const floatType   IC_InfTVAL[PHASE_SPACE_DIMENSIONS] = { 0, 0 };
static const floatType   IC_SupTVAL[PHASE_SPACE_DIMENSIONS] = { 3.5, 3.5 };
static const floatType	IC_MEAN[PHASE_SPACE_DIMENSIONS] = {2.2793, 0.0};
static const floatType	IC_STD [PHASE_SPACE_DIMENSIONS] = {sqrtf(0.0130f),sqrtf(0.00001f)};
...
inline const floatType 	_DIST_InfTVAL[PARAM_SPACE_DIMENSIONS] = {0.0f, 0.0f,0.0f};
inline const floatType 	_DIST_SupTVAL[PARAM_SPACE_DIMENSIONS] = {1.5f, 1.5f, 1.5f};
inline floatType 		_DIST_MEAN	 [PARAM_SPACE_DIMENSIONS] = {0.6734, 0.6755, 6.5325};
inline floatType 		_DIST_STD	 [PARAM_SPACE_DIMENSIONS] = {sqrtf(0.00092928f), sqrtf(0.0011f), sqrtf(0.1067f)};
...
// inline const floatType	IC_MEAN[PHASE_SPACE_DIMENSIONS] = {0.3, 0.0};
// inline const floatType	IC_STD [PHASE_SPACE_DIMENSIONS] = {sqrtf(0.000025f),sqrtf(0.000001f)};
...
// inline const floatType 	_DIST_InfTVAL[PARAM_SPACE_DIMENSIONS] = {0.0f, 0.0f,0.0f};
// inline const floatType 	_DIST_SupTVAL[PARAM_SPACE_DIMENSIONS] = {1.5f, 1.5f, 1.5f};
// inline floatType 		_DIST_MEAN	 [PARAM_SPACE_DIMENSIONS]	= {0.05, 0.2, 0.02};
// inline floatType 		_DIST_STD	 [PARAM_SPACE_DIMENSIONS]	= {sqrtf(0.002f), sqrtf(0.002f), sqrtf(0.001f)};
