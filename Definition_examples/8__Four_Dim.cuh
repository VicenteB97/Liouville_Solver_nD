...
static const floatType	IC_MEAN[PHASE_SPACE_DIMENSIONS] = {0, 1.2, 0, 1.2};
static const floatType	IC_STD[PHASE_SPACE_DIMENSIONS] = { sqrtf(0.00075),sqrtf(0.00075),sqrtf(0.00075),sqrtf(0.00075) };
