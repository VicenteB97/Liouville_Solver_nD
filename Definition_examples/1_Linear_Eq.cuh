...
inline const floatType	IC_MEAN[PHASE_SPACE_DIMENSIONS] = {0.17f};	
inline const floatType	IC_STD [PHASE_SPACE_DIMENSIONS] = {0.015f};	
...
inline const floatType 	_DIST_InfTVAL[PARAM_SPACE_DIMENSIONS] = {0.0f, 0.0f};
inline const floatType 	_DIST_SupTVAL[PARAM_SPACE_DIMENSIONS] = {1000.0f, 1000.0f};
inline floatType 		_DIST_MEAN	 [PARAM_SPACE_DIMENSIONS]	= {0.03f, 0.04f};
inline floatType 		_DIST_STD	 [PARAM_SPACE_DIMENSIONS]	= {0.02f, 0.02f};
...
#define IMPULSE_TYPE 1
	...
	inline const floatType  deltaImpulse_distribution_InfTVAL	[DiracDelta_impulseCount * PHASE_SPACE_DIMENSIONS] 	= {-1000, -1000, -1000};
	inline const floatType  deltaImpulse_distribution_SupTVAL	[DiracDelta_impulseCount * PHASE_SPACE_DIMENSIONS] 	= {0, 0, 0};
	inline floatType 		deltaImpulse_distribution_MEAN 	[DiracDelta_impulseCount * PHASE_SPACE_DIMENSIONS] 	= {-0.5, -0.5, -0.5};
	inline floatType 		deltaImpulse_distribution_STD  	[DiracDelta_impulseCount * PHASE_SPACE_DIMENSIONS] 	= {0.02f, 0.02f, 0.02f};
