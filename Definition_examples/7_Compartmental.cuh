...
static const floatType   IC_SupTVAL[PHASE_SPACE_DIMENSIONS] = { 2, 2 };
static const floatType	IC_MEAN[PHASE_SPACE_DIMENSIONS] = {1.2, 1.2};
static const floatType	IC_STD[PHASE_SPACE_DIMENSIONS] = { sqrtf(0.00075),sqrtf(0.00075) };
...
static floatType 		_DIST_MEAN[PARAM_SPACE_DIMENSIONS] = { 0.2,0.35,0.1,0.2 };
static floatType 		_DIST_STD[PARAM_SPACE_DIMENSIONS] = { sqrtf(0.005),sqrtf(0.005),sqrtf(0.002),sqrtf(0.002) };
